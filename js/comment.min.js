...
$("#comment-submit").click(function() {
    ...
    if (author.val() === "" || content.val() === "") {
       message.html("<p class='bg-danger' style='background-color: #ee5f5b;color:white;'>必填项未填写</p>");
        message.fadeIn(1000);
        setTimeout(function() {
...
function loadAvatar() {
    ...
    avatar.attr("src", "//cdn.v2ex.com/gravatar/" + md5(localStorage.getItem("email")) + "/" + avatarType+ ".png");
    if (email.val() !== "" && email.val() !== null) {
        avatar.attr("src", "//cdn.v2ex.com/gravatar/" + md5(email.val()) + "/" + avatarType + ".png");
    }
}
